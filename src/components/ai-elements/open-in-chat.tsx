...
const providers = {
  ...
  grok: {
    createUrl: (q: string) =>
      `https://grok.com/?${new URLSearchParams({
        q,
      })}`,
    icon: (
      <svg
      ...
      >
        <title>Grok</title>
        <path d="M395.48 633.83L735.91 381.11C752.6 368.71 776.45 373.55 784.41 392.79C826.26 494.29 807.56 616.25 724.29 700C641.02 783.74 525.15 802.1 419.25 760.28L303.56 814.14C469.49 928.2 670.99 900 796.9 773.28C896.78 672.84 927.71 535.94 898.78 412.48L899.05 412.74C857.11 231.37 909.36 158.87 1016.4 10.63C1018.93 7.12 1021.47 3.6 1024 0L883.14 141.65V141.21L395.39 633.92" />
        <path d="M325.23 695.25C206.13 580.84 226.66 403.78 328.29 301.67C403.43 226.1 526.55 195.25 634.03 240.6L749.45 186.99C728.66 171.88 702.01 155.62 671.42 144.2C533.19 86.99 367.69 115.47 255.32 228.38C147.23 337.08 113.24 504.21 171.61 646.83C215.22 753.42 143.74 828.82 71.74 904.92C46.22 931.89 20.62 958.87 0 987.43L325.14 695.34" />
      </svg>
    ),
    title: "Open in Grok",
  },
